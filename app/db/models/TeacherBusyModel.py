...
class TeacherBusyModel(BaseModel):
    ...
    teacher_id = Column('teacher_id', UUID(as_uuid=True),
                        ForeignKey('tbl_teachers.id', ondelete="CASCADE"), primary_key=True)
    ...
    lesson = Column('lesson', Enum(LessonsEnum),
                    ForeignKey('tbl_lessons.lesson_number'), nullable=False, primary_key=True)
